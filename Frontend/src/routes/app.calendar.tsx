  ...
  return (
    <div>
      <PageHeader
        ...
        description={
          isClient
            ? "Court dates, meetings, and deadlines for your matters."
            : "Firm-wide schedule across all cases."
        }
        actions={
          !isClient && (
            <Button>
              ...
              {(evs ?? []).map((e) => {
                ...
                return (
                  <div key={e.id} className="flex items-center gap-4 px-5 py-3.5">
                    ...
                    <div
                      className={`flex h-9 w-9 items-center justify-center rounded-md border ${meta.cls}`}
                    >
